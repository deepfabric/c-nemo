...
Status RangeDel(Nemo * nemo,const std::string  & start, const std::string & end, uint64_t limit);
Status RangeDelWithHandle(Nemo * nemo, rocksdb::DBWithTTL * db,const std::string  & start, const std::string & end, uint64_t limit);
